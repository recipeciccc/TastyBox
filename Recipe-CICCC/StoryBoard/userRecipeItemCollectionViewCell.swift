...
class userRecipeItemCollectionViewCell: UITableViewCell {
...
extension userRecipeItemCollectionViewCell: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
